...
const steps = [
  {
    ...
    description:
      "The foundation of every website. You'll learn how to build the structure of web pages using elements and tags.",
    topics: [
      "HTML Page Structure",
  ...
  },
  {
    ...
    levelColor: "text-green-400 bg-green-500/10 border-green-500/20",
    description:
      "Beautifying and designing your pages. CSS makes your website look professional and beautiful.",
    topics: [
  ...
  },
  {
    ...
    description:
      "The heart of web development. JavaScript adds interactivity and life to your pages.",
    topics: [
  ...
  },
  {
    ...
    description:
      "The most widely used library for building modern and fast user interfaces.",
    topics: [
      "Components & Props",
      "State & useState Hook",
      "useEffect & Lifecycle",
  ...
  },
  {
    ...
    description:
      "The backend side. You'll build APIs and servers that handle data.",
    topics: [
  ...
  },
  {
    ...
    levelColor: "text-red-400 bg-red-500/10 border-red-500/20",
    description:
      "Storing and managing data is the backbone of any real application. Learn MongoDB and SQL.",
    topics: [
      "MongoDB & Mongoose",
      "CRUD Operations",
...
const bonusTopics = [
  {
    icon: "🔒",
    title: "Git & GitHub",
    desc: "Code management and version control",
  },
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto text-lg">
            6 phases that take you from zero to building complete professional
            web applications.
          </p>
        ...
        <div className="mt-14 text-center glass-card rounded-3xl p-10 border border-purple-500/20 bg-linear-to-br from-purple-500/10 to-transparent">
          ...
          <p className="text-slate-400 mb-6">
            Go to the resources page to find the best videos and websites for
            each phase.
          </p>
          <button
